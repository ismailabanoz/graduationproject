...
namespace RegistrationDirectory.DataAccess.Migrations
{
    ...
    [Migration("20220715174742_addedAppUserRole")]
    partial class addedAppUserRole
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RegistrationDirectory.DataAccess.Models.AppUserRole", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("RegistrationDirectory.DataAccess.Models.RefreshTokenModel", b =>
                {
                    b.Property<string>("UserName")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("RegistrationDirectory.DataAccess.Models.AppUserRole", b =>
                {
                    b.HasOne("RegistrationDirectory.DataAccess.Models.AppRole", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RegistrationDirectory.DataAccess.Models.AppUser", "User")
                        .WithMany("UserRoles")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
